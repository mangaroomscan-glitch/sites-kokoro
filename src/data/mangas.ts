...
export const MOCK_MANGAS: Manga[] = [
  {
    ...
    synopsis: "Capítulo 1 em português do Brasil com 34 páginas. Leitura disponibilizada no catálogo da Kokoro Scans com comentários separados, favoritos e leitor personalizável para PC e celular.",
